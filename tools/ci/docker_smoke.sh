...
# Substitute: ledger, coworld-ledger, 8.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-ledger:ci)
#   SMOKE_SLUG                 game slug                        (ledger)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/ledger)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/ledger-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-ledger:ci}}"
slug="${SMOKE_SLUG:-ledger}"
